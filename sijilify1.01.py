...
class sijilify:
    def __init__(self, list_file = '' , certificate = '', font = '', y_pos = '', 
        ...
        if not os.path.isfile('sijilify.ini'):
    ...
    def __create_config(self):
        self.__config['generated-certificates'] = {'font_dir' : 'c:/windows/fonts/%(font)s',
                                                   'depo_dir' : 'deposits',
    ...
    def load_config(self, section = 'generated-certificates'):
        """
        ...
        """
        self.__config.read('sijilify.ini')
    ...
    def test(self):
        self.__config.read('sijilify.ini')
        self.list_file = self.__config.get('generated-certificates', 'file_list')
        self.certificate = self.__config.get('generated-certificates', 'file_certificate')
        self.font = self.__config.get('generated-certificates', 'font')
    ...
    def update(self, y_position = '', section = 'generated-certificates', font = '', file_list = '', 
        ...
        if font:
            parameter['font'] = font
        if file_list:
            parameter['file_list'] = file_list
        if file_certificate:
            parameter['file_certificate'] = file_certificate
        if font_size:
